    ...
    <div class="container-fluid pt-3">
        ...
        <div class="w-100 p-2">
            <div class="text-right mb-2 pr-3">
                <a href="/pengguna/tambah" class="btn btn-primary"><i class="fa fa-plus mr-1"></i><span
                ...
                @foreach($data as $v)
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="/pengguna/edit/{{ $v->id }}" class="btn btn-sm btn-warning btn-edit"
...
@section('js')
    ...
    <script type="text/javascript">
        function destroy(id) {
            AjaxPost('/pengguna/destroy', {id}, function () {
